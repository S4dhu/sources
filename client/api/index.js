...
const api = axios.create({
  baseURL: process.env.NODE_ENV === 'production' ? process.env.API_URI || 'http://194.58.111.114/api' : 'http://localhost:3000/api',
})

const userApi = axios.create({
  baseURL: process.env.NODE_ENV === 'production' ? process.env.API_URI || 'http://194.58.111.114/users' : 'http://localhost:3000/users',
})
